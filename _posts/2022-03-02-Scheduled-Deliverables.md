...
<ul><li>Game Services Team | 14% part-time with 14 task(s) scheduled, all of which are for SC</li>  
...
<li>Actor Feature Team | 35% part-time with 158 task(s) scheduled, 48% of which are for SQ42</li>  
