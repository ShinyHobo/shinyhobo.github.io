...
<ul>
  <li><a href="{{ '/tests/database-browser/#/browser' | relative_url}}">Database Terminal</a></li>
  <li><a href="{{ '/tests/database-browser/#/timeline' | relative_url}}">Scheduled Work Timeline</a></li>
</ul>
